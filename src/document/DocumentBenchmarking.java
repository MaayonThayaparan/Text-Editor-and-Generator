...
public class DocumentBenchmarking {
	...
	public static void main(String [] args) {
				...
				numToCheck += increment)
		{
			...
			double basicTime = (endBasic - startBasic) * 100000000.0;
			...
			double effTime = (endEff - startEff) * 100000000.0;
			System.out.print(effTime + "\n");
